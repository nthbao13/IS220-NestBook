...
namespace BookNest.Areas.Customer.Controllers
{
    ...
    public class OrderController : BaseCustomerController
    {
        ...
        public async Task<IActionResult> Payment()
        {
            ...
            Order Order = _context.Orders.Where(o => o.Status == "CREATED")
        ...
        private decimal CalculateDiscountAmount(Voucher voucher, decimal subtotal)
        {
            ...
            {
                decimal discountAmount = subtotal * (voucher.Value ?? 0);
        ...
        private decimal GetOrderSubtotal()
        {
            ...
            var order = _context.Orders
                .Where(o => o.Status == "CREATED" && o.UserId == user.Id)
                .Include(o => o.OrderDetails)
        ...
        public async Task<IActionResult> ProcessPayment([FromBody] ProcessPaymentRequest request)
        {
            try
            {
                ...
                var order = await _context.Orders
                    ...
                    .FirstOrDefaultAsync(o => o.Id == request.OrderId && o.UserId == user.Id && o.Status == "CREATED");
